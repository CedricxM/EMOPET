...
/**
 * Convert un payload JSON non fiable en `NewContactInput` uniquement après
 * validation structurelle et bornage des champs. Les règles métier (formats,
 * dates futures, consentement) restent dans `validateContactInput()`.
 */
