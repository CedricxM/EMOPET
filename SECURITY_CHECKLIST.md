...
- [ ] `PRIVILEGED_JWT_SECRET`, `JWT_SECRET`, `REPORT_SHARE_SECRET` and `CORS_ORIGIN` are configured in production.
- [ ] `PRIVILEGED_JWT_SECRET` is distinct from the ordinary `JWT_SECRET`.
