...
## Corrected unsupported Oniris attachment lineage

The prior ledger entry `EMOPET_INSTITUTIONAL_PRESENTATION_2026_FR.pdf` addressed to a supposed Oniris recipient was removed as transmission evidence after connected-Gmail searches for the cited recipient/subject returned no result.

The actually evidenced 3 September outbound uses `EMOPET_Presentation.pdf` and Gmail message `1a0670d0ac6b7ca7`.
