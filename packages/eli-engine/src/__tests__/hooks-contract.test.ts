 ...
 *
 * This exercises existing hook/gating behavior only. It does not validate the
 * scientific meaning of ELI outputs and does not turn the engine-local
 * candidate into the shared cross-surface InferenceResult contract.
 */
